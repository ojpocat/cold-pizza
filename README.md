...
Overall, our models performed better than random guessing, which would be an accuracy of 0.33934 and a mean squared error (MSE) of 0.8734. Our models performed with an accuracy between 0.5 and 0.7 and a MSE between 0.4 and 0.3. Even our worst-performing model performed much better than random guessing. 
